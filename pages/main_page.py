...
class MainPage(BasePage):
    ...
    def click_order_feed_button(self):
        self.close_modal_if_exists(OrderModalLocators.CLOSE_BUTTON)
        button = self.wait.until(EC.element_to_be_clickable(MainPageLocators.ORDER_FEED_BUTTON))
    ...
    def switch_to_buns_tab(self):
        buns_tab = self.wait.until(EC.element_to_be_clickable(MainPageLocators.BUNS_TAB))
        self.click_js(buns_tab)
    ...
    def drag_and_drop_ingredient(self, ingredient_locator):
        ...
        self.scroll_to_element(ingredient, 'center')
        self.scroll_to_element(constructor_area, 'center')
    ...
    def get_order_number_from_modal(self):
        ...
        self.wait.until(lambda d: get_clean_order_number() not in ["9999", ""])
